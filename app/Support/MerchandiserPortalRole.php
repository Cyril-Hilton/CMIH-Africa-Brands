    ...
    public static function all(): array
    {
        return [
            self::FIELD => [
                ...
                'icon' => '<i class="fa-solid fa-mobile-screen-button text-amber-400"></i>',
            ...
            self::SUPERVISOR => [
                ...
                'icon' => '<i class="fa-solid fa-compass text-amber-400"></i>',
            ...
            self::ADMIN => [
                ...
                'icon' => '<i class="fa-solid fa-shield-halved text-amber-400"></i>',
            ...
            self::CLIENT => [
                ...
                'icon' => '<i class="fa-solid fa-chart-pie text-amber-400"></i>',
