...
.liquid-tile.arc-0 { transform: translateX(50px) translateY(68px) rotate(-11deg) scale(.68); z-index: 1; opacity: 0.76; }
.liquid-tile.arc-1 { transform: translateY(45px) rotate(-7deg) scale(.94); z-index: 3; opacity: 0.90; }
.liquid-tile.arc-2 { transform: translateY(18px) rotate(-3deg) scale(1.12); z-index: 5; opacity: 0.98; }
.liquid-tile.arc-3 {
  min-height: 185px;
  flex: 0 0 250px;
  width: 250px;
  height: 185px;
  transform: translateY(0px) rotate(0deg) scale(1.24);
  z-index: 10;
  opacity: 1;
  filter: drop-shadow(0 25px 50px rgba(0,0,0,0.65));
}
.liquid-tile.arc-4 { transform: translateY(18px) rotate(3deg) scale(1.12); z-index: 5; opacity: 0.98; }
.liquid-tile.arc-5 { transform: translateY(45px) rotate(7deg) scale(.94); z-index: 3; opacity: 0.90; }
.liquid-tile.arc-6 { transform: translateX(-50px) translateY(68px) rotate(11deg) scale(.68); z-index: 1; opacity: 0.76; }

.liquid-tile.arc-0:hover { transform: translateX(50px) translateY(58px) rotate(-11deg) scale(.74); z-index: 20; opacity: 1; }
.liquid-tile.arc-1:hover { transform: translateY(35px) rotate(-7deg) scale(1.00); z-index: 20; opacity: 1; }
.liquid-tile.arc-2:hover { transform: translateY(8px) rotate(-3deg) scale(1.18); z-index: 20; opacity: 1; }
.liquid-tile.arc-3:hover { transform: translateY(-10px) rotate(0deg) scale(1.30); z-index: 20; opacity: 1; }
.liquid-tile.arc-4:hover { transform: translateY(8px) rotate(3deg) scale(1.18); z-index: 20; opacity: 1; }
.liquid-tile.arc-5:hover { transform: translateY(35px) rotate(7deg) scale(1.00); z-index: 20; opacity: 1; }
.liquid-tile.arc-6:hover { transform: translateX(-50px) translateY(58px) rotate(11deg) scale(.74); z-index: 20; opacity: 1; }
