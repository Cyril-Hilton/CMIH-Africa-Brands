...
<section class="brands-prototype view active home" id="view-home">
    ...
    <div class="merch-bridge">
        <a href="{{ route('merchandisers.portal') }}" class="merch-btn">Merchandiser Portal Sign In -></a>
    </div>
    ...
    <div class="brand-zone" id="brands">
        ...
        <div class="brand-carousel-wrap" data-brand-carousel>
            ...
            <div class="carousel-controls">
                <button type="button" class="carousel-arrow" data-carousel-prev aria-label="Previous brands">&lt;</button>
                <div class="carousel-count" id="carouselCount">1 / {{ max($brands->count(), 1) }}</div>
                <button type="button" class="carousel-arrow" data-carousel-next aria-label="Next brands">&gt;</button>
            </div>
        </div>
    </div>
</section>
