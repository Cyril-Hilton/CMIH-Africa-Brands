                <div x-show="activeTab === 'skus'" x-cloak x-transition class="sku-catalog space-y-5">
                    <div class="merch-card border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 shadow-sm rounded-2xl">
                        ...
                        <div class="mt-4 flex flex-wrap gap-2">
                            <a href="{{ route('merchandisers.admin.tab', ['tenant' => $merchTenant['code'], 'adminTab' => 'kds']) }}" class="rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-slate-900 dark:text-white hover:bg-slate-200 dark:hover:bg-slate-700 transition">Outlets & KDs</a>
                            <a href="{{ route('merchandisers.admin.tab', ['tenant' => $merchTenant['code'], 'adminTab' => 'routes']) }}" class="rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-slate-900 dark:text-white hover:bg-slate-200 dark:hover:bg-slate-700 transition">Routes</a>
                            <a href="{{ route('merchandisers.admin.tab', ['tenant' => $merchTenant['code'], 'adminTab' => 'forms']) }}" class="rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-slate-900 dark:text-white hover:bg-slate-200 dark:hover:bg-slate-700 transition">Forms & Planograms</a>
                            <a href="{{ route('merchandisers.admin.tab', ['tenant' => $merchTenant['code'], 'adminTab' => 'category-kpi']) }}" class="rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-slate-800 px-3 py-2 text-[10px] font-bold uppercase tracking-wider text-slate-900 dark:text-white hover:bg-slate-200 dark:hover:bg-slate-700 transition">KPI Targets</a>
                        </div>
                    </div>
