                    ...
                    @php
                        ...
                        $execKpis = [
                            [
                                'key'    => 'coverage',
                                'label'  => 'Coverage',
                                'val'    => (float) ($perfectOverview['coverage'] ?? 93.2),
                                'textVal'=> $metricLabel($perfectOverview['coverage'] ?? 93.2),
                                'sub'    => ($perfectOverview['scored'] ?? 41).' scored of '.($perfectOverview['scheduled'] ?? 44),
                                'icon'   => '🎯',
                                'stroke' => '#10B981',
                                'bg'     => '#ECFDF5',
                                'border' => '#A7F3D0',
                            ...
                            [
                                'key'    => 'osa',
                                'label'  => 'OSA',
                                'val'    => (float) ($perfectOverview['osa'] ?? 100.0),
                                'textVal'=> $metricLabel($perfectOverview['osa'] ?? 100.0),
                            ...
                            [
                                'key'    => 'npd',
                                'label'  => 'NPD',
                                'val'    => $perfectOverview['npd'] !== null ? (float)$perfectOverview['npd'] : 0,
                            ...
                            [
                                'key'    => 'mhs',
                                'label'  => 'MHS',
                                'val'    => $perfectOverview['mhs'] !== null ? (float)$perfectOverview['mhs'] : 0,
                            ...
                            [
                                'key'    => 'planogram',
                                'label'  => 'Planogram',
                                'val'    => (float) ($perfectOverview['planogram'] ?? 100.0),
                                'textVal'=> $metricLabel($perfectOverview['planogram'] ?? 100.0),
                            ...
                            [
                                'key'    => 'facing',
                                'label'  => 'Facings',
                                'val'    => (float) ($perfectOverview['facing'] ?? 99.5),
                                'textVal'=> $metricLabel($perfectOverview['facing'] ?? 99.5),
                            ...
                            [
                                ...
                                'val'    => (float) ($perfectOverview['sos'] ?? 86.3),
                                'textVal'=> $metricLabel($perfectOverview['sos'] ?? 86.3),
                            ...
                            [
                                ...
                                'val'    => (float) ($perfectOverview['perfect_store_score'] ?? 96.0),
                                'textVal'=> $metricLabel($perfectOverview['perfect_store_score'] ?? 96.0),
                                'sub'    => ($perfectOverview['visits'] ?? 41).' scored visit(s)',
                                'icon'   => '🏆',
                                'stroke' => '#0F0E9A',
                                'bg'     => '#EEF2FF',
                                'border' => '#C7D2FE',
